...
int main()
{
    ...
    n = p * q;
    phi_n = (p - 1) * (q - 1);  // Corrected minus sign
...
<img width="1572" height="785" alt="image" src="https://github.com/user-attachments/assets/45d235b8-9987-40f8-8edf-91ba96c62f69" />
